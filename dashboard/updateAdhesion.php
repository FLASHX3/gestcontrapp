<?php
    ...
    if (isset($_POST["enregistrer"])){
        ...
        try{
            ...
            $updateAdhesion->execute(array($negoce, $val_off, $info_client, $elab_contrat, $trans_contrat, $final_dossier, $control_final, $val_doss, $trans_contrat_remise, $trans_decharge, $recept_doc, $archivage_doc, $id_operatoire));
            $updateAdhesion->closeCursor();

            $verif = $bdd->prepare("SELECT * FROM `adhesion`");
            $verif->execute();
