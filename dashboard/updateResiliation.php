...
if (isset($_POST["save"])) {
    ...
    try {
        ...
        $updateAdhesion->execute(array($preavis, $const_trans_elem_repert, $preval_dossier, $val_dos_res, $trans_elem_res, $trans_rep_client, $etat_lieux, $const_trans_elem_res, $control_val, $approb_doc_final, $paiement, $archivage_doc, $id_mode));
